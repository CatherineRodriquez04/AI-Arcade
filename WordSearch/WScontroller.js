...
function WordSearchController(gameId, listId, solveId, newGameId, themeId, challengeId, timerId) {
	...
	var searchTypes = {
		...
		"Arcade!🕹️": [["controller", "pixels", "algorithm", "highscore"],
		...
		"Countries!🗺️": [["united states", "canada", "brazil", "germany"],
        ...
        "Disney!✨": [["mickey", "minnie", "cinderella", "pixar"],
			["frozen", "aladdin", "little mermaid", "goofy"],
			["donald duck", "snow white", "mulan", "moana"],
			["jungle book", "pocahontas", "pinocchio", "tangled"],
			["lion king",  "dumbo",  "jack sparrow", "buzz lightyear"]],

        "Ocean Life!🪼": [["coral", "dolphin", "shark", "octupus"],
			["reef", "jellyfish", "seahorse", "whale"],
			["squid", "seaweed", "starfish", "clam"],
			["mantee", "lobster", "crab", "eel"],
			["manta ray",  "algae",  "tide", "sea turtle"]],

        "Mystical Creatures!🐉": [["dragon", "unicorn", "griffin", "phoenix"],
			["mermaid", "centaur", "hydra", "kraken"],
			["goblin", "siren", "chimera", "pegasus"],
			["gorgon", "harpy", "troll", "yeti"],
			["sasquatch",  "banshee",  "leviathan", "kitsune"]],

        "Sports!🏈": [["basketball", "soccer", "tennis", "dance"],
			["baseball", "track", "volleyball", "hockey"],
			["gymnastics", "swimming", "rugby", "cricket"],
			["wrestling", "cycling", "golf", "skiing"],
			["surfing",  "fencing",  "badminton", "sailing"]],

        "Wildlife!🐘": [["tiger", "elephant", "panda", "eagle"],
			["giraffe", "lion", "bear", "kangaroo"],
			["wolf", "zebra", "leopard", "rhino"],
			["cheetah", "otter", "penguin", "fox"],
			["deer",  "bison",  "jaguar", "sloth"]],

        "Colleges!🎓": [["LSU", "Alabama", "Clemson", "Ohio State"],
        ...
        "Space Exploration!🚀": [["NASA", "apollo", "astronaut", "moon"],
			["mars", "rover", "rocket", "satellite"],
			["space shuttle", "galaxy", "telescope", "solar system"],
			["milky way", "black hole", "comet", "gravity"],
			["meteor",  "nebula",  "spacewalk", "pluto"]],

        "Superheros!💪": [["batman", "superman", "wonder women", "spiderman"],
